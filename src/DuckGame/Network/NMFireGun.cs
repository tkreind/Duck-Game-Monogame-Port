...
namespace DuckGame
{
  public class NMFireGun : NMEvent
  {
    ...
    {
      if ((int) this._levelIndex != (int) DuckNetwork.levelIndex || this.gun != null && (int) this.gun.bulletFireIndex >= (int) this.fireIndex)
        return;
      ...
      foreach (NMFireBullet fireEvent in this._fireEvents)
        fireEvent.DoActivate(this.position, this.owner < (byte) 4 ? DuckNetwork.profiles[(int) this.owner] : (Profile) null);
      if (this.gun == null)
        return;
