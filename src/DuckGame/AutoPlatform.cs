...
namespace DuckGame
{
  public abstract class AutoPlatform : MaterialThing, IAutoTile, IPlatform, IDontMove, IPathNodeBlocker
  {
    ...
    {
      AutoPlatform autoPlatform1 = Level.CheckPointPlacementLayer<AutoPlatform>(this.x, this.y - 16f, (Thing) this, this.placementLayer);
      AutoPlatform autoPlatform2 = Level.CheckPointPlacementLayer<AutoPlatform>(this.x, this.y + 16f, (Thing) this, this.placementLayer);
      ...
      AutoPlatform autoPlatform5 = Level.CheckPointPlacementLayer<AutoPlatform>(this.x - 16f, this.y - 16f, (Thing) this, this.placementLayer);
      AutoPlatform autoPlatform6 = Level.CheckPointPlacementLayer<AutoPlatform>(this.x + 16f, this.y - 16f, (Thing) this, this.placementLayer);
      AutoPlatform autoPlatform7 = Level.CheckPointPlacementLayer<AutoPlatform>(this.x - 16f, this.y + 16f, (Thing) this, this.placementLayer);
      AutoPlatform autoPlatform8 = Level.CheckPointPlacementLayer<AutoPlatform>(this.x + 16f, this.y + 16f, (Thing) this, this.placementLayer);
