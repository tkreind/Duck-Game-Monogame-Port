  ...
  public class Noise
  {
    ...
    public static float Generate(float x, float y)
    {
      ...
      else
      {
        ...
        num14 = num12 * num12 * Noise.grad((int) Noise.perm[num9 + num7 + (int) Noise.perm[index + num8]], x4, y2);
      }
      float num15 = (float) (0.5 - (double) x5 * (double) x5 - (double) y3 * (double) y3);
      float num16;
      if ((double) num15 < 0.0)
      {
        num16 = 0.0f;
      ...
      {
        float num12 = num15 * num15;
        num16 = num12 * num12 * Noise.grad((int) Noise.perm[num9 + 1 + (int) Noise.perm[index + 1]], x5, y3);
      }
      return (float) (40.0 * ((double) num11 + (double) num14 + (double) num16));
    }
    ...
    public static float Generate(float x, float y, float z)
    {
      ...
      {
        float num16 = num17 * num17;
        num18 = num16 * num16 * Noise.grad((int) Noise.perm[num12 + num6 + (int) Noise.perm[num13 + num7 + (int) Noise.perm[index + num8]]], x8, y2, z2);
      }
      float num19 = (float) (0.600000023841858 - (double) x9 * (double) x9 - (double) y3 * (double) y3 - (double) z3 * (double) z3);
      float num20;
      if ((double) num19 < 0.0)
      {
        num20 = 0.0f;
      ...
      {
        float num16 = num19 * num19;
        num20 = num16 * num16 * Noise.grad((int) Noise.perm[num12 + num9 + (int) Noise.perm[num13 + num10 + (int) Noise.perm[index + num11]]], x9, y3, z3);
      }
      float num21 = (float) (0.600000023841858 - (double) x10 * (double) x10 - (double) y4 * (double) y4 - (double) z4 * (double) z4);
      float num22;
      if ((double) num21 < 0.0)
      {
        num22 = 0.0f;
      ...
      {
        float num16 = num21 * num21;
        num22 = num16 * num16 * Noise.grad((int) Noise.perm[num12 + 1 + (int) Noise.perm[num13 + 1 + (int) Noise.perm[index + 1]]], x10, y4, z4);
      }
      return (float) (32.0 * ((double) num15 + (double) num18 + (double) num20 + (double) num22));
    }
