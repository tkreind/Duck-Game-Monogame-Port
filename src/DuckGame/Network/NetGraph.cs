...
namespace DuckGame
{
  public class NetGraph
  {
    ...
    public void Draw() => DevConsole.UpdateGraph(NetworkDebugger.networkDrawingIndex, this);
    ...
    public void DrawChart(Vec2 pos)
    {
      ...
      if (num2 >= this._currentMaxSize)
        ...
        this._currentMaxSize -= 2;
      ++NetGraph.numFrames;
      NetGraph.numBytes += NCBasic.bytesThisFrame;
      NetGraph.numHeaderBytes += NCBasic.headerBytes;
      NetGraph.numGhostBytes += NCBasic.ghostBytes;
      NetGraph.numAckBytes += NCBasic.ackBytes;
      ...
      public void Draw(SpriteBatch batch, string text, float xpos, float ypos, Color c)
      {
        ...
        for (int index = 0; index < text.Length; ++index)
        {
          ...
          else
          {
            ...
            int num3 = character % 16 * this._tileSize;
            int num4 = character / 16 * this._tileSize;
            batch.Draw(this._texture, (Vector2) new Vec2(xpos + num2, ypos), new Microsoft.Xna.Framework.Rectangle?((Microsoft.Xna.Framework.Rectangle) new Rectangle((float) num3, (float) num4, (float) this._tileSize, (float) this._tileSize)), (Microsoft.Xna.Framework.Color) c, 0.0f, (Vector2) Vec2.Zero, (Vector2) new Vec2(1f, 1f), SpriteEffects.None, 1f);
